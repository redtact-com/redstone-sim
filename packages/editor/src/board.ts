 ...
 *
 * ※ #272 まではここが**描画側で崩れていた**。deepslate の StructureRenderer が
 * 既定で「空セル 1 個につき 12 本の線」の mesh を作っていたため、盤面を広げるだけで
 * **体積に比例**したコストが乗っていた (64³ で 11.5 秒)。
 * `useInvisibleBlockBuffer: false` を渡して解消済み。
 *
